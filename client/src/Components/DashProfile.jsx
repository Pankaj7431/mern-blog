...
export default function DashProfile() {
  ...
  console.log(imgFileProgress, imgFileError);
  ...
  return (
    <div className="max-w-lg mx-auto p-3 w-full min-h-screen">
      ...
      <form className="flex flex-col gap-4">
        ...
        >
          ...
          <img
            ...
            border-[lightgray] object-cover ${imgFileProgress && imgFileProgress < 100 && 'opacity-60'}`}
          />
        </div>
      ...
      <div className="text-red-500 flex justify-between mt-5">
        <span className="cursor-pointer">Delete this account?</span>
